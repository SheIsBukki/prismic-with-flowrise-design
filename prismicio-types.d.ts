...
/**
 * Item in *Features → Default → Primary → Repeatable Feature Group*
 */
export interface FeaturesSliceDefaultPrimaryRepeatableFeatureGroupItem {
  /**
   * Icon field in *Features → Default → Primary → Repeatable Feature Group*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **Default Value**: calendar
   * - **API ID Path**: features.default.primary.repeatable_feature_group[].icon
  ...
  /**
   * Title field in *Features → Default → Primary → Repeatable Feature Group*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.repeatable_feature_group[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Description field in *Features → Default → Primary → Repeatable Feature Group*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.repeatable_feature_group[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface FeaturesSliceDefaultPrimary {
  ...
  /**
   * Repeatable Feature Group field in *Features → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.repeatable_feature_group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  repeatable_feature_group: prismic.GroupField<
    Simplify<FeaturesSliceDefaultPrimaryRepeatableFeatureGroupItem>
  >;
}
...
export interface TestimonialsSliceDefaultPrimaryTestimonialGroupItem {
  /**
   * Testimonial field in *Testimonials → Default → Primary → Testimonial Group*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: testimonials.default.primary.testimonial_group[].testimonial
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      FeaturesSlice,
      FeaturesSliceDefaultPrimaryRepeatableFeatureGroupItem,
